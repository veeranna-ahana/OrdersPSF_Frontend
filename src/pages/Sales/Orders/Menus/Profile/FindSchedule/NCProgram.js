    ...
    <div className="row">
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-3">
          ...
          <button className="button-style" style={{ width: "240px" }}>
        ...
        <div  className="col-md-2">
        <Link to="/Orders/Profile/FindSchedule">
...
<button className="button-style">Close</button>
    ...
    {/* <div className="row mt-4" style={{ overflowY: "scroll" }}>
