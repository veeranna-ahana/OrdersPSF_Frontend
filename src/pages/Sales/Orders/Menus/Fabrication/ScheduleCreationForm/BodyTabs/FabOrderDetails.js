...
import FabImportOldOrder from "./Buttons/FabImportOldOrder";
import FabDrawing from "./DrawingOrderDetailsTabs/FabDrawing";
import FabOrderDetailsForm from "./DrawingOrderDetailsTabs/FabOrderDetailsForm";
import { Tab, Tabs, Table } from "react-bootstrap";
import FabImportParameters from "./Buttons/FabImportParameters";
import { useState } from "react";
import { Link } from "react-router-dom";
import AlertModal from "../../Components/Alert";

export default function FabOrderDetails() {
  ...
  return (
    <div>
      <div className="row mt-2">
        ...
        <div className="col-md-2 mt-2 col-sm-12">
          <Link to="/Orders/Fabrication/ImportQtn">
        ...
        <div className="col-md-2 mt-2 col-sm-12">
          <Link to="/Orders/Fabrication/EditDxf">
